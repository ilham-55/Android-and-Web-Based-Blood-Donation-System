...
public class DoctorList extends AppCompatActivity {
    ...
    //  private Button btnDoctorDivision, btnDoctorSpecialist, btnDoctorSearch, btnSearchHospitalinMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList =  findViewById(R.id.listView_doctorslist_details);
...
//        imgNoData.setVisibility(View.INVISIBLE);
    ...
    private void getData(String text) {
        ...
        loading = new ProgressDialog(DoctorList.this);
        loading.setMessage("Please wait....");
        loading.show();

        String URL = Constant.HOSPITAL_DOCTOR_URL + "?text=" + text+"&id="+getId;
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toast.makeText(DoctorList.this, "Network Error!", Toast.LENGTH_SHORT).show();
                    }
                });

        RequestQueue requestQueue = Volley.newRequestQueue(DoctorList.this);
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            if (result.length() == 0) {
                Toast.makeText(DoctorList.this, "No Doctor Available!", Toast.LENGTH_SHORT).show();
        ...
        adapter = new SimpleAdapter(
                DoctorList.this, list, R.layout.doctors_list_item,
        ...
        CustomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(DoctorList.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_call) {
            Intent intent = new Intent(Intent.ACTION_DIAL);
            intent.setData(Uri.parse("tel:"+ getCell));
            startActivity(intent);
            return true;
        }
