...
if ((isset($_POST['name'])) != "" && (isset($_POST['address'])) != "" && (isset($_POST['cell'])) != "" && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($status == "OK") {
        ...
        if ($num_rows > 0) {
            ...
            if (mysqli_query($con, "INSERT INTO plasma_donor (`name`,`address`,`cell`,`blood_group`) VALUE ('$name','$address','$cell','$blood_group')")) {
                echo '<script type="text/javascript">';
            ...
            <div class="form-group">
                <div class="col-xs-10">
                    ...
                    <br>
                     ...
                     <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="blood_group" id="name"
