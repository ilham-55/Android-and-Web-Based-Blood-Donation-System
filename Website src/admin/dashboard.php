    ...
    <div class="main-panel">
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <div>
                    <button id="my_box" type="button" class="btn btn-block btn-fill pull-left"><h3>Total Doctors
                            </h3>
                        <h1><?php echo $total_doctor; ?></h1>
                    </button>
                ...
                <div>
                    <button id="my_box" type="button" class="btn btn-block btn-fill pull-left"><h3>Total Hospitals</h3>
                        <h1><?php echo $total_hospital; ?></h1>
                    </button
            ...
            <div class="col-md-12" align="justify">
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td><font color="black"><?php echo $row['id'] ?></font></td>
                    </tr>
                    <tr>
                ...
                <div>
                    <button id="my_button" type="button" class="btn btn-block btn-fill pull-right"
