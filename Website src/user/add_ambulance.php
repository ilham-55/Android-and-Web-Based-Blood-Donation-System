...
if ((isset($_POST['name'])) != "" && (isset($_POST['address'])) != "" && (isset($_POST['cell'])) != "" && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($status == "OK") {
        ...
        $result = mysqli_query($con, "SELECT * FROM ambulance_list where name='$name'");
        ...
        if ($num_rows > 0) {
            ...
            if (mysqli_query($con, "INSERT INTO ambulance_list (`name`,`address`,`mobile`) VALUE ('$name','$address','$cell')")) {
                echo '<script type="text/javascript">';
